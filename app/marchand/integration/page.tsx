...
></moetly-button>`;
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <h1 className="text-xl sm:text-2xl font-[family-name:var(--font-sora)] font-bold text-gray-900 mb-2">
        Intégration
      </h1>
      ...
      <div className="space-y-6">
        ...
        <Card padding="lg">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <code className="flex-1 bg-gray-100 px-3 sm:px-4 py-3 rounded-xl text-xs sm:text-sm font-mono text-gray-700 border border-gray-200 truncate">
