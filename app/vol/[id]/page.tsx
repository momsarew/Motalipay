      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mt-6 bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            {[
              { icon: Lock, text: 'Prix bloqué' },
              { icon: CreditCard, text: 'Sans crédit' },
              { icon: Calendar, text: 'Payez progressivement' },
            ].map(({ icon: Icon, text }) => (
              <div key={text} className="flex flex-col items-center text-center py-3 bg-gray-50 rounded-xl">
                <Icon className="w-5 h-5 text-blue-primary mb-1" />
